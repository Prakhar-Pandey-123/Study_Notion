...
{/*  to: Indicates the gradient’s direction.
br: Short for "bottom-right", meaning the gradient starts at the bottom-left corner and ends at the top-right corner.from= Starts with purple,via= Midpoint color (red),to= Ends with orange-yellow */}
