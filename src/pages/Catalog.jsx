...
const Catalog = () => {
  ...
  // to either show most popular or new courses
    const [catalogPageData, setCatalogPageData] = useState(null);
    const [categoryId, setCategoryId] = useState("");

    //Fetch all categories and get the id of category which is on param
    useEffect(()=> {
    ...
    useEffect(() => {
        ...
        // If you have that categoryId then fetch all the page data related to it
        if(categoryId) {
            getCategoryDetails();
        }
