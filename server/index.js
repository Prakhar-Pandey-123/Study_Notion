...
//In your index.js file, you then import this router and give it a name (userRoutes in this case). You then "mount" this router onto a specific path (like /api/v1/auth/...(signup or login) ), meaning all the routes inside the userRoutes will be prefixed with /api/v1/auth(same prefix)
