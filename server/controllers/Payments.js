...
exports.enrollStudents=async(req,res)=>{
    ...
    const userId=req.user.id;
        // courses contains various courses to be buyed by the user
        // validation
     if(!courses || !userId){
   ...
   for(const courseId of courses){
    try{
        // add student in that enrolledStudents field of the course
        ...
        // add the course id in the courses field of the student
        ...
        // send email notification to enrolled student .,courseName,name
